- [消息语法和路由](rfc7230/README.md)
    ...
    - [附录A. HTTP版本历史](rfc7230/Appendix_A_HTTP_Version_History/README.md)
        - [A.1 从HTTP/1.0的改变](rfc7230/Appendix_A_HTTP_Version_History/Changes_from_http10/README.md)
            - [A.1.1 多宿主Web服务器](rfc7230/Appendix_A_HTTP_Version_History/Changes_from_http10/Multihomed_Web_Servers.md)
            - [A.1.2 Keep-Alive连接](rfc7230/Appendix_A_HTTP_Version_History/Changes_from_http10/Keep-Alive_Connections.md)
            - [A.1.3 Transfer-Encoding介绍](rfc7230/Appendix_A_HTTP_Version_History/Changes_from_http10/Introduction_of_Transfer-Encoding.md)
        - [A.2 从RFC2612的改变](rfc7230/Appendix_A_HTTP_Version_History/Changes_from_RFC_2612.md)
